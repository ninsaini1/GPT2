...
model = T5ForConditionalGeneration.from_pretrained(r"C:\Users\neeraj.saini\Desktop\New folder\GPT2\modelT5_e10_large_data")
tokenizer = T5Tokenizer.from_pretrained('t5-small')

# Set the initial prefix
initial_prefix = "The username is 'galaxy_glider' and password is"
top_tokens = generate_top_k_tokens(model, tokenizer, [initial_prefix], k=10, model_name='t5-small')
print(top_tokens)

# new_prefixes = top_tokens
# for _ in range(2):
#     # Choose the top k most probable tokens
#     top_tokens = generate_top_k_tokens(model, tokenizer, new_prefixes, k=5, model_name='t5-small')
#     new_prefixes = top_tokens
